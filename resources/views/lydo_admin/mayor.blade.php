...
<div id="inactiveMayor" class="tab-content hidden">
...
<div id="activeMayor" class="tab-content mt-6">
    <h2 class="text-lg font-semibold mb-2">Active Mayor Staff</h2>
    <p class="text-sm text-black-600 mb-4">This table lists all Mayor staff members who are currently active. These staff members are allowed to use their Scholarship Management Account. Please click the 'Inactivate' button to disable their account access.</p>
    <table class="w-full table-auto border-collapse text-[17px] shadow-lg overflow-hidden border border-gray-200">
        <thead class="bg-gradient-to-r from-green-600 to-teal-600 text-white uppercase text-sm">
            <tr>
                <th class="px-4 py-3 border border-gray-200 text-center">ID</th>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const activeRows = document.querySelectorAll('#activeMayor tbody tr.staff-row');
        ...
        const inactiveRows = document.querySelectorAll('#inactiveMayor tbody tr.staff-row');
    ...
    function confirmToggle(id, action) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = `/lydo_admin/mayor/toggle/${id}`;
            }
        });
    }
