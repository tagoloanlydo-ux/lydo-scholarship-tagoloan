      ...
      <div class="w-full max-w-sm space-y-6">
        ...
        <form method="POST" action="{{ route('scholar.password.email') }}" novalidate id="forgotForm">
          ...
          <div>
            ...
            <input id="email" name="email" type="email" value="{{ old('email') }}" required autofocus class="mt-2 w-full bg-white rounded-lg px-4 py-3 text-gray-700 shadow-sm text-lg border @error('email') border-red-500 @enderror" placeholder="Enter your email address"/>
            @error('email')
